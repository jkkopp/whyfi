...
// The actual GitHub mark (Octicons' "mark-github" path), not a hand-rolled
// approximation — it needs to be recognizable as *the* GitHub logo, which a
// simplified stroke shape wouldn't be. Filled, not stroked, unlike NavIcon.
export function GitHubIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width={18} height={18} viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" {...props}>
